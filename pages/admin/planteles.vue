  ...
  <div>
    ...
    <div class="flex justify-between items-center mb-8">
      <div>
        ...
        <p class="text-slate-500 mt-1">Administra las sucursales y sus presupuestos.</p>
      </div>
...
const form = ref({ codigo: '', nombre: '', presupuesto_mensual: 0, activo: true });
...
const openModal = (item = null) => {
  if (item) {
    ...
    form.value = { codigo: '', nombre: '', presupuesto_mensual: 0, activo: true };
